...
class DeepLab(nn.Module):
    def __init__(self,cfg):
        ...
        # 配置信息
        # 配置信息
        self.nInputChannels = cfg.n_channels
        self.n_classes = cfg.n_classes

        os = 16

        # Atrous Conv
        self.resnet_features = ResNet101(self.nInputChannels, os)
...
if __name__ == "__main__":
    net = DeepLabv3_plus(nInputChannels=3, os=8, pretrained=False, _print=True)
    # 參數兩
    ######################################
