...
class MYDataSet(Dataset):
    ...
    def __getitem__(self,index):
        ...
        train_A_img = cv2.imread(train_A_img_path) # 400,400,3
        train_B_img = cv2.imread(train_B_img_path,0) # 400,400

        train_A_img = cv2.resize(train_A_img,(640,224),cv2.INTER_CUBIC)
        train_B_img = cv2.resize(train_B_img,(640,224),cv2.INTER_CUBIC)
