...
parser.add_argument('--trainA_path', type=str,
                    default='edge_seg/images')
parser.add_argument('--train_file', type=str,
                    default='edge_seg/train.txt')
parser.add_argument('--trainB_path', type=str,
                    default='edge_seg/masks')
parser.add_argument('--lr', type=float, default=1e-4, help='learning rate')
parser.add_argument('--max_epoch', type=int, default=500,
                    help='Max epoch for training')
parser.add_argument('--bz', type=int, default=2,
...
parser.add_argument('--gpu_list', type=list,
                    default=None, help='Use multiple GPU to train the model')
...
if __name__ == "__main__":
    ...
    if args.gpu_list:
        ...
        model = UNet_3Plus(n_classes=1).cuda()
    model.train()
